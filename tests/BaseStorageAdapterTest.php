...
abstract class BaseStorageAdapterTest extends TestCase
{
    ...
    public function unescapeBinary(): void
    {
        ...
        /** @var \Desperado\ServiceBus\Storage\ResultSet $iterator */
    ...
    /**
     * @test
     * @expectedException \Desperado\ServiceBus\Storage\Exceptions\OneResultExpected
    ...
    /**
     * @test
     * @expectedException \Desperado\ServiceBus\Storage\Exceptions\UniqueConstraintViolationCheckFailed
     *
     * @return void
     *
     * @throws \Throwable
